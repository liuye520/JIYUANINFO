    ...
    <>
      ...
      <section className="py-16 px-20">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div>
            <div className="text-[42px] font-extrabold text-[#2B5AED]">60%</div>
            <div className="text-sm text-[#86909C]">就医效率提升</div>
          </div>
          <div>
            <div className="text-[42px] font-extrabold text-[#7B61FF]">200+</div>
            <div className="text-sm text-[#86909C]">接入医疗机构</div>
          </div>
          <div>
            <div className="text-[42px] font-extrabold text-[#10B981]">100万+</div>

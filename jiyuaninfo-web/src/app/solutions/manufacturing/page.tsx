    ...
    <>
      ...
      <section className="py-16 px-20">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div>
            <div className="text-[42px] font-extrabold text-[#2B5AED]">98%</div>
            <div className="text-sm text-[#86909C]">设备联网率</div>
          </div>
          <div>
            <div className="text-[42px] font-extrabold text-[#7B61FF]">25%</div>
          ...
          <div>
            <div className="text-[42px] font-extrabold text-[#FF7D00]">99.5%</div>

    ...
    <>
      ...
      <section className="py-12 px-4 md:py-16 md:px-10 lg:px-20">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 text-center">
          <div>
            <div className="text-2xl md:text-[32px] lg:text-[42px] font-extrabold text-[#2B5AED]">200+</div>
            <div className="text-sm text-[#86909C]">服务社区</div>
          </div>
          <div>
            <div className="text-2xl md:text-[32px] lg:text-[42px] font-extrabold text-[#7B61FF]">50万+</div>
